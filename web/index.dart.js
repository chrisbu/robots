...
$$.MajorCompassFacing = {"": "Object;ident<,move",
  turnLeft$0: function() {
    var t1, t2;
    t1 = $.get$MajorCompassFacing__directionCycle();
    t2 = $.JSArray_methods.indexOf$2($.get$MajorCompassFacing__directionCycle(), this, 1) - 1;
    if (t2 >>> 0 !== t2 || t2 >= t1.length)
      throw $.ioore(t2);
    return t1[t2];
  },
  turnRight$0: function() {
    var t1, t2;
    t1 = $.get$MajorCompassFacing__directionCycle();
    t2 = $.JSArray_methods.indexOf$2($.get$MajorCompassFacing__directionCycle(), this, 0) + 1;
    if (t2 >>> 0 !== t2 || t2 >= t1.length)
      throw $.ioore(t2);
    return t1[t2];
  },
  ...
  $eq: function(_, other) {
    ...
    if (t1)
      return false;
    if (t1 || typeof other !== "object" || other === null || !$.getInterceptor(other).$isMajorCompassFacing)
      return false;
    return this.ident === other.get$ident();
  },
  toString$0: function(_) {
    return "MajorCompassPoint: " + this.ident;
  },
  $isMajorCompassFacing: true
};

$$.closure = {"": "Closure;",
  call$1: function(p) {
    var t1 = $.getInterceptor$x(p);
    return $.Position$0(t1.get$x(p), $.$add$ns(t1.get$y(p), 1));
  }
};
...
$$.closure2 = {"": "Closure;",
  call$1: function(p) {
    var t1 = $.getInterceptor$x(p);
    return $.Position$0($.$add$ns(t1.get$x(p), 1), t1.get$y(p));
  }
};
...
$$.closure1 = {"": "Closure;",
  call$1: function(p) {
    var t1 = $.getInterceptor$x(p);
    return $.Position$0(t1.get$x(p), $.$sub$n(t1.get$y(p), 1));
  }
};
...
$$.closure0 = {"": "Closure;",
  call$1: function(p) {
    var t1 = $.getInterceptor$x(p);
    return $.Position$0($.$sub$n(t1.get$x(p), 1), t1.get$y(p));
  }
};

$$.Planet = {"": "Object;maxPosition,minPosition,_robotScents"};

$$.RobotError = {"": "RuntimeError;message",
  toString$0: function(_) {
    return "RobotError: " + this.message;
  }
};

$$.Robot = {"": "Object;commandLibrary<,facing,position,_isActive,commandQueue",
  runCommand$2: function(commandChar, planet) {
    var t1, command, result;
    $.Primitives_printString("Running: " + $.S(commandChar));
    t1 = this.commandLibrary;
    command = t1.$index(t1, $.toUpperCase$0$s(commandChar));
    if (command == null)
      throw $.wrapException($.RobotError$("I don't understand command: " + $.S(commandChar)));
    if (this._isActive) {
      result = command.execute$1(this);
      if (!$.$eq(result.facing, this.facing))
        this.facing = result.facing;
      this._applyPositionChange$2(result, planet);
    }
    return this._isActive;
  },
  _applyPositionChange$2: function(result, planet) {
    var t1;
    if (!$.$eq(result.position, this.position)) {
      t1 = result.position;
      if (t1.$gt(t1, planet.maxPosition) === true || t1.$lt(t1, planet.minPosition) === true) {
        t1 = planet._robotScents;
        if ($.JSArray_methods.contains$1(t1, this.position))
          ;
        else {
          t1.push(this.position);
  ...
  Robot$3: function(initialization, commandsToProcess, availableCommands) {
    var elements, t1, positionString, t2, i;
    if (initialization.length === 0)
      throw $.wrapException($.ArgumentError$("initialization"));
    elements = $.JSString_methods.trim$0(initialization).split(" ");
    t1 = elements.length;
    if (t1 !== 3)
      throw $.wrapException($.ArgumentError$("initialization should contain three distinct elements"));
    if (0 >= t1)
      throw $.ioore(0);
    t1 = $.S(elements[0]) + " ";
    if (1 >= elements.length)
      throw $.ioore(1);
    positionString = t1 + $.S(elements[1]);
    $.MajorCompassFacing_initialize();
    this.position = $.Position$fromString(positionString);
    t1 = $.get$MajorCompassFacing_facings();
    if (2 >= elements.length)
      throw $.ioore(2);
    this.facing = t1.$index(t1, elements[2]);
    if (this.facing == null)
      throw $.wrapException($.ArgumentError$("facingChar must be one of N E S W"));
    $.JSArray_methods.forEach$1(availableCommands, new $.Robot_closure(this));
    for (t1 = this.commandQueue, t2 = commandsToProcess.length, i = 0; i < t2; ++i)
      t1.add$1(t1, commandsToProcess[i]);
  }
};

$$.Robot_closure = {"": "Closure;this_0",
  call$1: function(command) {
    var t1 = this.this_0.get$commandLibrary();
    t1.$indexSet(t1, command.get$commandChar(), command);
    return command;
  }
};

$$.StringConversionError = {"": "RuntimeError;message",
  toString$0: function(_) {
    return "StringConversionError: " + this.message;
  }
};

$$.Position = {"": "Object;_x,_y",
  get$x: function(_) {
    return this._x;
  },
  ...
  set$y: function(_, value) {
    if (value == null)
      throw $.wrapException($.ArgumentError$("y"));
    this._y = value;
  },
  $eq: function(_, other) {
    var t1, t2;
    ...
    if (t1)
      return false;
    return $.$eq(this._x, t2.get$x(other)) && $.$eq(this._y, t2.get$y(other));
  },
  $gt: function(_, other) {
    var t1;
    $.Primitives_printString("Other: " + $.S(other));
    t1 = $.getInterceptor(other);
    if (other == null)
      return $.throwExpression($.ArgumentError$("other is null or not a point: " + $.S(other)));
    return $.$gt$n(this._x, t1.get$x(other)) === true || $.$gt$n(this._y, t1.get$y(other)) === true;
  },
  $lt: function(_, other) {
    var t1 = $.getInterceptor(other);
    if (other == null)
      return $.throwExpression($.ArgumentError$(other));
    return $.$lt$n(this._x, t1.get$x(other)) === true || $.$lt$n(this._y, t1.get$y(other)) === true;
  },
  toString$0: function(_) {
    return $.S($.Object.prototype.toString$0.call(this, this)) + ": [" + $.S(this._x) + ", " + $.S(this._y) + "]";
  },
  Position$2: function(x, y) {
    this.set$x(this, x);
    this.set$y(this, y);
  },
  Position$fromString$1: function(positionStr) {
    var elements, t1;
    if (positionStr == null)
      throw $.wrapException($.ArgumentError$("positionStr"));
    elements = $.split$1$s(positionStr, " ");
    t1 = elements.length;
    if (t1 !== 2)
      throw $.wrapException($.ArgumentError$("positionStr: " + $.S(positionStr)));
    if (0 >= t1)
      throw $.ioore(0);
    this._x = $.int_parse(elements[0], new $.Position$fromString_closure(), null);
    if (1 >= elements.length)
      throw $.ioore(1);
    this._y = $.int_parse(elements[1], new $.Position$fromString_closure0(), null);
  },
  $isPosition: true
};

$$.Position$fromString_closure = {"": "Closure;",
  call$1: function(err) {
    return $.throwExpression($.StringConversionError$(err));
  }
};

$$.Position$fromString_closure0 = {"": "Closure;",
  call$1: function(err) {
    return $.throwExpression($.StringConversionError$(err));
  }
};

$$.CommandResult = {"": "Object;position,facing",
  CommandResult$2: function(pos, facing) {
    var t1;
    $.print(pos);
    t1 = $.getInterceptor$x(pos);
    this.position = $.Position$(t1.get$x(pos), t1.get$y(pos));
    this.facing = facing;
  }
};

$$.Command = {"": "Object;commandChar<"};

$$.TurnLeftCommand = {"": "Object;commandChar<",
  execute$1: function(robot) {
    return $.CommandResult$(robot.position, robot.facing.turnLeft$0());
  }
};

$$.TurnRightCommand = {"": "Object;commandChar<",
  execute$1: function(robot) {
    return $.CommandResult$(robot.position, robot.facing.turnRight$0());
  }
};

$$.MoveForwardCommand = {"": "Object;commandChar<",
  execute$1: function(robot) {
    var result;
    $.Primitives_printString($.toString$0(robot.position));
    $.Primitives_printString($.toString$0(robot.facing));
    result = robot.facing.move$1(robot.position);
    $.Primitives_printString($.JSBool_methods.toString$0(typeof result === "object" && result !== null && !!$.getInterceptor(result).$isPosition));
    $.Primitives_printString($.toString$0(result));
    return $.CommandResult$(result, robot.facing);
  }
};

$$.main_closure = {"": "Closure;",
  call$1: function(e) {
    var input, result, ex, exception, t1;
    input = $.get$value$x(document.querySelector("#input"));
    result = "";
    try {
      result = $.landOnMars(input);
      if ($.$eq($.get$length$asx(result), 0))
        result = "Ran successfully, but there was no output. Perhaps you forgot the robots?";
    } catch (exception) {
      t1 = $.unwrapException(exception);
      ex = t1;
      result = $.toString$0(ex);
    }

    $.set$innerHtml$x(document.querySelector("#output"), result);
  }
};

$$.main_closure0 = {"": "Closure;",
  call$1: function(e) {
    $.set$value$x(document.querySelector("#input"), "");
  }
};

$$.main_closure1 = {"": "Closure;",
  call$1: function(e) {
    $.set$innerHtml$x(document.querySelector("#output"), "");
  }
};

$$.Position0 = {"": "Object;_liblib1$_x,_liblib1$_y",
  get$x: function(_) {
    return this._liblib1$_x;
  },
  set$x: function(_, value) {
    if (value == null)
      throw $.wrapException($.ArgumentError$("x"));
    this._liblib1$_x = value;
  },
  get$y: function(_) {
    return this._liblib1$_y;
  },
  set$y: function(_, value) {
    if (value == null)
      throw $.wrapException($.ArgumentError$("y"));
    this._liblib1$_y = value;
  },
  $eq: function(_, other) {
    var t1, t2;
    t1 = other == null;
    ...
    if (t1)
      return false;
    return $.$eq(this._liblib1$_x, t2.get$x(other)) && $.$eq(this._liblib1$_y, t2.get$y(other));
  },
  $gt: function(_, other) {
    var t1;
    $.Primitives_printString("Other: " + $.S(other));
    ...
    if (other == null)
      return $.throwExpression($.ArgumentError$("other is null or not a point: " + $.S(other)));
    return $.$gt$n(this._liblib1$_x, t1.get$x(other)) === true || $.$gt$n(this._liblib1$_y, t1.get$y(other)) === true;
  },
  $lt: function(_, other) {
    var t1 = $.getInterceptor(other);
    if (other == null)
      return $.throwExpression($.ArgumentError$(other));
    return $.$lt$n(this._liblib1$_x, t1.get$x(other)) === true || $.$lt$n(this._liblib1$_y, t1.get$y(other)) === true;
  },
  toString$0: function(_) {
    return $.S($.Object.prototype.toString$0.call(this, this)) + ": [" + $.S(this._liblib1$_x) + ", " + $.S(this._liblib1$_y) + "]";
  },
  Position$2: function(x, y) {
    this.set$x(this, x);
    this.set$y(this, y);
...
$.ListQueue_ListQueue$from = function(source) {
  ...
  queue = $.ListQueue$($length + 1);
  t1 = queue._table;
  if (!!t1.immutable$list)
    $.throwExpression($.UnsupportedError$("set range"));
  $.IterableMixinWorkaround_setRangeList(t1, 0, $length, source, 0);
  queue._tail = $length;
  return queue;
};
...
$.MajorCompassFacing_MajorCompassFacing$_ = function(ident, moveFunc) {
  var t1, result;
  t1 = $.get$MajorCompassFacing_facings();
  result = t1.$index(t1, ident);
  if (result == null) {
    result = $.MajorCompassFacing$_ctor(ident, moveFunc);
    t1 = $.get$MajorCompassFacing_facings();
    t1.$indexSet(t1, ident, result);
  }
  return result;
};

$.MajorCompassFacing$_ctor = function(ident, move) {
  return new $.MajorCompassFacing(ident, move);
};

$.MajorCompassFacing_initialize = function() {
  var t1, t2;
  $.get$MajorCompassFacing_NORTH();
  $.get$MajorCompassFacing_EAST();
  $.get$MajorCompassFacing_SOUTH();
  $.get$MajorCompassFacing_WEST();
  t1 = $.get$MajorCompassFacing__directionCycle();
  t2 = $.get$MajorCompassFacing_NORTH();
  if (0 >= t1.length)
    throw $.ioore(0);
  t1[0] = t2;
  t2 = $.get$MajorCompassFacing__directionCycle();
  t1 = $.get$MajorCompassFacing_EAST();
  if (1 >= t2.length)
    throw $.ioore(1);
  t2[1] = t1;
  t1 = $.get$MajorCompassFacing__directionCycle();
  t2 = $.get$MajorCompassFacing_SOUTH();
  if (2 >= t1.length)
    throw $.ioore(2);
  t1[2] = t2;
  t2 = $.get$MajorCompassFacing__directionCycle();
  t1 = $.get$MajorCompassFacing_WEST();
  if (3 >= t2.length)
    throw $.ioore(3);
  t2[3] = t1;
  t1 = $.get$MajorCompassFacing__directionCycle();
...
$.landOnMars = function(commands) {
  var t1, commandLines, commandQueue, marsSize, planetMars, result, robot, t2, t3, msg;
  t1 = $.getInterceptor(commands);
  if (commands == null || t1.trim$0(commands).length === 0)
    throw $.wrapException($.ArgumentError$("commands must be specified"));
  commandLines = t1.replaceAll$2(commands, "\r\n", "\n").split("\n");
  if (commandLines.length === 0)
    throw $.wrapException($.RuntimeError$("Cannot create Mars - no commands entered"));
  commandQueue = $.ListQueue_ListQueue$from(commandLines);
  marsSize = commandQueue.removeFirst$0();
  $.Primitives_printString("creating mars");
  planetMars = $.Planet$($.Position$fromString(marsSize));
  $.Primitives_printString("created mars");
  result = $.StringBuffer$("");
  robot = $.getNextRobot(commandQueue);
  $.Primitives_printString("Got next robot: " + $.S(robot));
  for (t1 = $.getInterceptor(commandQueue); robot != null;) {
    while (true) {
      robot.get$isActive;
      if (robot._isActive) {
        robot.get$hasCommands;
        t2 = robot.commandQueue;
        t2 = !t2.get$isEmpty(t2);
      } else
        t2 = false;
      if (!t2)
        break;
      robot.runNextCommand$1;
      t2 = robot.commandQueue;
      if (!(t2.get$isEmpty(t2) || robot.runCommand$2(t2.removeFirst$0(), planetMars)))
        break;
    }
    robot.get$isActive;
    t2 = robot._isActive;
    ...
    if (t2) {
      ...
      t3 = robot.position;
      t3.get$y;
      msg = t2 + $.S(t3._y) + " " + $.S(robot.facing.get$ident());
      result._contents = result._contents + msg;
      ...
      t3 = robot.position;
      t3.get$y;
      msg = t2 + $.S(t3._y) + " " + $.S(robot.facing.get$ident()) + " LOST";
      result._contents = result._contents + msg;
      result._contents = result._contents + "\n";
    }
    $.Primitives_printString(t1.toString$0(commandQueue));
    robot = $.getNextRobot(commandQueue);
    $.Primitives_printString("Got next robot: " + $.S(robot));
  }
  return result._contents;
...
$.getNextRobot = function(commandQueue) {
  var t1, robot, initialization;
  t1 = $.getInterceptor$asx(commandQueue);
  robot = null;
  while (true) {
    if (!(t1.get$isEmpty(commandQueue) !== true && robot == null))
      break;
    initialization = $.trim$0$s(commandQueue.removeFirst$0());
    if (initialization.length > 0)
      if (t1.get$isEmpty(commandQueue) !== true) {
        $.Primitives_printString("Init: " + initialization);
        $.Primitives_printString("Cmds: robotCommands");
        robot = $.Robot$(initialization, $.trim$0$s(commandQueue.removeFirst$0()), [$.TurnLeftCommand$(), $.TurnRightCommand$(), $.MoveForwardCommand$()]);
      } else
        throw $.wrapException($.RuntimeError$("Robot initialization exists without commands"));
  }
  return robot;
};

$.Planet$ = function(maxPosition) {
  return new $.Planet(maxPosition, $.Position$(0, 0), $.List_List($));
};

$.RobotError$ = function(msg) {
  return new $.RobotError(msg);
};

$.Robot$ = function(initialization, commandsToProcess, availableCommands) {
  var t1 = new $.Robot($.Map_Map(), null, null, true, $.Queue_Queue());
  t1.Robot$3(initialization, commandsToProcess, availableCommands);
  return t1;
};

$.StringConversionError$ = function(stringValue) {
  return new $.StringConversionError("Could not convert " + $.S(stringValue));
};
...
$.Position$fromString = function(positionStr) {
  var t1 = new $.Position(null, null);
  t1.Position$fromString$1(positionStr);
  return t1;
};

$.CommandResult$ = function(pos, facing) {
  var t1 = new $.CommandResult(null, null);
  t1.CommandResult$2(pos, facing);
  return t1;
};

$.TurnLeftCommand$ = function() {
  return new $.TurnLeftCommand("L");
};

$.TurnRightCommand$ = function() {
  return new $.TurnRightCommand("R");
};

$.MoveForwardCommand$ = function() {
  return new $.MoveForwardCommand("F");
};

$.main = function() {
  var t1 = document.querySelector("#run");
  t1.get$onClick;
  ...
  t1 = document.querySelector("#clearInput");
  t1.get$onClick;
  t1 = $.EventStreamProvider_click.forTarget$1(t1);
  $._EventStreamSubscription$(t1._target, t1._eventType, new $.main_closure0(), t1._useCapture);
  t1 = document.querySelector("#clearOutput");
  t1.get$onClick;
  t1 = $.EventStreamProvider_click.forTarget$1(t1);
  $._EventStreamSubscription$(t1._target, t1._eventType, new $.main_closure1(), t1._useCapture);
};

$.Position$0 = function(x, y) {
  var t1 = new $.Position0(null, null);
  t1.Position$2(x, y);
  return t1;
};
...
Isolate.$lazy($, "facings", "MajorCompassFacing_facings", "get$MajorCompassFacing_facings", function() {
  return $.Map_Map();
});
Isolate.$lazy($, "NORTH", "MajorCompassFacing_NORTH", "get$MajorCompassFacing_NORTH", function() {
  return $.MajorCompassFacing_MajorCompassFacing$_("N", new $.closure());
});
Isolate.$lazy($, "EAST", "MajorCompassFacing_EAST", "get$MajorCompassFacing_EAST", function() {
  return $.MajorCompassFacing_MajorCompassFacing$_("E", new $.closure2());
});
Isolate.$lazy($, "SOUTH", "MajorCompassFacing_SOUTH", "get$MajorCompassFacing_SOUTH", function() {
  return $.MajorCompassFacing_MajorCompassFacing$_("S", new $.closure1());
});
Isolate.$lazy($, "WEST", "MajorCompassFacing_WEST", "get$MajorCompassFacing_WEST", function() {
  return $.MajorCompassFacing_MajorCompassFacing$_("W", new $.closure0());
});
Isolate.$lazy($, "_directionCycle", "MajorCompassFacing__directionCycle", "get$MajorCompassFacing__directionCycle", function() {
  return $.List_List(5);
});
// Native classes
